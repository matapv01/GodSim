...
export interface DialogManagerDeps {
  ...
  onNpcMessage?: (npcId: string, text: string) => void
}
...
export class DialogManager {
  ...
  private onNpcMessage: (npcId: string, text: string) => void
  ...
  constructor(deps: DialogManagerDeps) {
    ...
    this.onNpcMessage = deps.onNpcMessage ?? (() => {})
  }
