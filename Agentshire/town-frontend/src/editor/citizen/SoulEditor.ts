...
export class SoulEditor {
  ...
  render(soulContent: string, onChange: (content: string) => void): void {
    ...
    toggle.innerHTML = `
      ...
      <span>${l('Sửa Soul đầy đủ', 'Edit Full Soul', '编辑完整 Soul')}</span>
    `
    ...
    ta.placeholder = l('Sửa file Soul Markdown đầy đủ ở đây...\n\nBấm "AI tạo" để tự tạo', 'Edit full Soul Markdown here...\n\nClick "AI Generate" to auto-create', '在此编辑完整的 Soul Markdown 文件...\n\n点击「AI 生成」可自动创建')
    ...
    aiBtn.textContent = l('✦ AI tạo', '✦ AI Generate', '✦ AI 生成')
  ...
  private async triggerAIGeneration(btn: HTMLElement): Promise<void> {
    ...
    btn.textContent = l('⏳ Đang tạo...', '⏳ Generating...', '⏳ 生成中...')
    ...
    btn.textContent = l('✦ AI tạo', '✦ AI Generate', '✦ AI 生成')
