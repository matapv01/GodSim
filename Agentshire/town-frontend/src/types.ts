...
export const WAYPOINTS: Record<string, Waypoint> = {
  ...
  office_door: { x: 54.0, z: 14.0 },
  coworking_door: { x: 64.0, z: 14.0 },
  ...
  market_door: { x: 54.0, z: 81.0 },
  cafe_door: { x: 62.0, z: 81.0 },
  restaurant_door: { x: 54.0, z: 73.0 },
  user_home_door: { x: 16.0, z: 83.0 },
  museum_door: { x: 52.0, z: 16.0 },
...
export const LOCATION_ZONES: Record<string, LocationZone> = {
  office_door:     { x: 54.0, z: 14.0, w: 6.8, d: 3.0, color: 0x4aa3df },
  coworking_door:  { x: 64.0, z: 14.0, w: 4.8, d: 2.8, color: 0x4aa3df },
