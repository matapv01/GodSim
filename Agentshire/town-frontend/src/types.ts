...
export const WAYPOINTS: Record<string, Waypoint> = {
  road_entrance: { x: 28.0, z: 32.0 },
  plaza_center: { x: 27.4, z: 18.6 },
  plaza_fountain: { x: 27.4, z: 18.6 },
  plaza_side: { x: 31.4, z: 18.6 },
  office_door: { x: 48.0, z: 13.0 },
  coworking_door: { x: 58.0, z: 13.0 },
  house_a_door: { x: 8.0, z: 17.0 },
  house_b_door: { x: 8.0, z: 21.5 },
  house_c_door: { x: 8.0, z: 26.0 },
  house_d_door: { x: 73.0, z: 13.0 },
  house_e_door: { x: 72.0, z: 22.0 },
  house_f_door: { x: 8.0, z: 54.0 },
  house_g_door: { x: 6.0, z: 43.0 },
  clinic_door: { x: 8.5, z: 13.0 },
  market_door: { x: 50.0, z: 46.0 },
  cafe_door: { x: 50.0, z: 54.0 },
  restaurant_door: { x: 62.0, z: 46.0 },
  user_home_door: { x: 6.0, z: 49.0 },
  museum_door: { x: 64.0, z: 53.0 },
  park_bench_1: { x: 53.5, z: 23.0 },
  park_bench_2: { x: 58.5, z: 23.0 },
  park_center: { x: 56.0, z: 23.0 },
  gathering_point: { x: 27.4, z: 20.4 },
}

export const LOCATION_ZONES: Record<string, LocationZone> = {
  office_door:     { x: 48.0, z: 13.0,  w: 6.8, d: 3.0, color: 0x4aa3df },
  coworking_door:  { x: 58.0, z: 13.0,  w: 4.8, d: 2.8, color: 0x4aa3df },
  house_a_door:    { x: 8.0,  z: 17.0,  w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_b_door:    { x: 8.0,  z: 21.5, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_c_door:    { x: 8.0,  z: 26.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_d_door:    { x: 73.0, z: 13.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_e_door:    { x: 72.0, z: 22.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_f_door:    { x: 8.0,  z: 54.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_g_door:    { x: 6.0,  z: 43.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  clinic_door:     { x: 8.5,  z: 13.0,  w: 3.8, d: 2.6, color: 0x70d6ff },
  market_door:     { x: 50.0, z: 46.0,  w: 5.6, d: 3.0, color: 0xffd166 },
  cafe_door:       { x: 50.0, z: 54.0,  w: 5.0, d: 3.0, color: 0xd4a574 },
  restaurant_door: { x: 62.0, z: 46.0, w: 5.2, d: 3.0, color: 0xf28f5b },
  user_home_door:  { x: 6.0,  z: 49.0,  w: 3.4, d: 2.4, color: 0xddaa44 },
  museum_door:     { x: 64.0, z: 53.0, w: 5.3, d: 2.8, color: 0xb8b8ff },
  park_center:     { x: 56.0, z: 23.0, w: 7.0, d: 3.8, color: 0x6ee07f },
}
