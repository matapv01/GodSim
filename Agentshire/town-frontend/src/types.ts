...
export const WAYPOINTS: Record<string, Waypoint> = {
  road_entrance: { x: 76.0, z: 12.0 },
  plaza_center: { x: 76.0, z: 24.0 },
  plaza_fountain: { x: 76.0, z: 24.0 },
  plaza_side: { x: 72.5, z: 24.0 },
  office_door: { x: 62.0, z: 14.0 },
  coworking_door: { x: 72.0, z: 14.0 },
  house_a_door: { x: 11.0, z: 18.0 },
  house_b_door: { x: 17.0, z: 18.0 },
  house_c_door: { x: 11.0, z: 25.0 },
  house_d_door: { x: 17.0, z: 25.0 },
  house_e_door: { x: 11.0, z: 68.0 },
  house_f_door: { x: 17.0, z: 68.0 },
  house_g_door: { x: 11.0, z: 76.0 },
  clinic_door: { x: 16.0, z: 11.0 },
  market_door: { x: 62.0, z: 81.0 },
  cafe_door: { x: 70.0, z: 81.0 },
  restaurant_door: { x: 62.0, z: 73.0 },
  user_home_door: { x: 16.0, z: 83.0 },
  museum_door: { x: 60.0, z: 16.0 },
  park_bench_1: { x: 63.0, z: 24.0 },
  park_bench_2: { x: 69.0, z: 24.0 },
  park_center: { x: 66.0, z: 24.0 },
  gathering_point: { x: 76.0, z: 25.6 },
}

export const LOCATION_ZONES: Record<string, LocationZone> = {
  office_door:     { x: 62.0, z: 14.0, w: 6.8, d: 3.0, color: 0x4aa3df },
  coworking_door:  { x: 72.0, z: 14.0, w: 4.8, d: 2.8, color: 0x4aa3df },
  house_a_door:    { x: 11.0, z: 18.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_b_door:    { x: 17.0, z: 18.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_c_door:    { x: 11.0, z: 25.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_d_door:    { x: 17.0, z: 25.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_e_door:    { x: 11.0, z: 68.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_f_door:    { x: 17.0, z: 68.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_g_door:    { x: 11.0, z: 76.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  clinic_door:     { x: 16.0, z: 11.0, w: 3.8, d: 2.6, color: 0x70d6ff },
  market_door:     { x: 62.0, z: 81.0, w: 5.6, d: 3.0, color: 0xffd166 },
  cafe_door:       { x: 70.0, z: 81.0, w: 5.0, d: 3.0, color: 0xd4a574 },
  restaurant_door: { x: 62.0, z: 73.0, w: 5.2, d: 3.0, color: 0xf28f5b },
  user_home_door:  { x: 16.0, z: 83.0, w: 3.4, d: 2.4, color: 0xddaa44 },
  museum_door:     { x: 60.0, z: 16.0, w: 5.3, d: 2.8, color: 0xb8b8ff },
  park_center:     { x: 66.0, z: 24.0, w: 7.0, d: 3.8, color: 0x6ee07f },
}
