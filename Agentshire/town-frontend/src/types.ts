...
export const WAYPOINTS: Record<string, Waypoint> = {
  ...
  plaza_center: { x: 25.6, z: 14.5 },
  plaza_fountain: { x: 25.6, z: 14.5 },
  plaza_side: { x: 30.4, z: 14.5 },
  office_door: { x: 24.4, z: 13.0 },
  coworking_door: { x: 31.6, z: 13.0 },
  house_a_door: { x: 6.0, z: 7.5 },
  house_b_door: { x: 6.0, z: 13.0 },
  house_c_door: { x: 6.0, z: 18.5 },
  house_d_door: { x: 6.0, z: 24.0 },
  house_e_door: { x: 12.0, z: 24.0 },
  house_f_door: { x: 12.0, z: 18.5 },
  house_g_door: { x: 12.0, z: 13.0 },
  clinic_door: { x: 9.5, z: 13.0 },
  market_door: { x: 45.0, z: 13.0 },
  cafe_door: { x: 46.0, z: 29.0 },
  restaurant_door: { x: 52.0, z: 20.5 },
  user_home_door: { x: 11.2, z: 29.4 },
  museum_door: { x: 52.0, z: 29.0 },
  park_bench_1: { x: 16.0, z: 29.5 },
  park_bench_2: { x: 22.0, z: 29.5 },
  park_center: { x: 18.4, z: 29.5 },
  gathering_point: { x: 32.8, z: 23.5 },
}

export const LOCATION_ZONES: Record<string, LocationZone> = {
  office_door:     { x: 24.4, z: 13.0,  w: 6.8, d: 3.0, color: 0x4aa3df },
  coworking_door:  { x: 31.6, z: 13.0,  w: 4.8, d: 2.8, color: 0x4aa3df },
  ...
  house_e_door:    { x: 12.0, z: 24.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_f_door:    { x: 12.0, z: 18.5, w: 3.2, d: 2.4, color: 0x5ccf7a },
  house_g_door:    { x: 12.0, z: 13.0, w: 3.2, d: 2.4, color: 0x5ccf7a },
  clinic_door:     { x: 9.5,  z: 13.0,  w: 3.8, d: 2.6, color: 0x70d6ff },
  market_door:     { x: 45.0, z: 13.0,  w: 5.6, d: 3.0, color: 0xffd166 },
  cafe_door:       { x: 46.0, z: 29.0,  w: 5.0, d: 3.0, color: 0xd4a574 },
  restaurant_door: { x: 52.0, z: 20.5, w: 5.2, d: 3.0, color: 0xf28f5b },
  user_home_door:  { x: 11.2, z: 29.4,  w: 3.4, d: 2.4, color: 0xddaa44 },
  museum_door:     { x: 52.0, z: 29.0, w: 5.3, d: 2.8, color: 0xb8b8ff },
  park_center:     { x: 18.4, z: 29.5, w: 7.0, d: 3.8, color: 0x6ee07f },
}
